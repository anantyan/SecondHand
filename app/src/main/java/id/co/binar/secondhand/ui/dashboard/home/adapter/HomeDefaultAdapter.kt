...
class HomeDefaultAdapter : ListAdapter<GetProductResponse, RecyclerView.ViewHolder>(diffUtillProduct) {
...
val diffUtillProduct = object : DiffUtil.ItemCallback<GetProductResponse>() {
